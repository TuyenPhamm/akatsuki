            ...
            <div class=" grid grid-cols-3 px-[30px] max-lg:grid-cols-2 max-md:grid-cols-1">
                    ...
                    <div class="flex mt-[30px]">
                        <div>
                            <img class="rounded-full"
                                src="http://www.wp1.themexlab.com/newwp/bristol/wp-content/uploads/2017/01/author-3.jpg"
                                alt="">
                        </div>
                        <div class="pl-[18px]">
                ...
                <div class="pr-[70px] max-md:hidden">
                    ...
                    <div class="flex mt-[30px]">
                        <div>
                            <img class="rounded-full"
                                src="	http://www.wp1.themexlab.com/newwp/bristol/wp-content/uploads/2017/01/author-1.jpg"
                                alt="">
                        </div>
                        <div class="pl-[18px]">
                ...
                <div class="pr-[70px] max-lg:hidden">
                    ...
                    <div class="flex mt-[30px]">
                        <div>
                            <img class="rounded-full"
                                src="http://www.wp1.themexlab.com/newwp/bristol/wp-content/uploads/2017/01/author-2.jpg"
                                alt="">
                        </div>
                        <div class="pl-[18px]">
